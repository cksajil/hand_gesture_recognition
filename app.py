...
Memory updated
Got it! Since your GIF files are located inside the static folder, the http.server will automatically serve them. Here’s how you can set up the server to serve GIF files from that directory:
